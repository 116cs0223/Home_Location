...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,LocationListener
{
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        mMap = googleMap; // add map to our fragment
    ...
    String getPlace_Name(double lati, double longi)
    {
        ...
        while (cursor.moveToNext()) {
            ...
            ArrayList<MapsActivity2.Info_Points> arrayList = gson.fromJson(json, new TypeToken<ArrayList<MapsActivity2.Info_Points>>() {
            }.getType());
           ...
           /* First_Activity.Info_Points i_array[]=null;
            ...
            MapsActivity2.Info_Points i_array[] = new MapsActivity2.Info_Points[arrayList.size()];
